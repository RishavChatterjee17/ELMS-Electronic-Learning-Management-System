   ...
   <script src="timer1.js"></script>
     ...
     <div class="body">
       <form name="mcq" onsubmit="return onSubmit()">
        ...
        <div class="question">
          <h3>< b> tag makes the enclosed text bold. What is other tag to make text bold?</h3>
          <input type="radio" name="q2"value="a">a. < strong><br>
            <input type="radio" name="q2"value="b">b.< dar><br>
              <input type="radio" name="q2"value="c">c. < black><br>
                <input type="radio" name="q2"value="d">d.< emp><br>
         </div>
