  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
        ...
        <li><a class='active'href="css margins.jsp">Margins</a></li>
...
<a href = "css padding.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "css icons.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
