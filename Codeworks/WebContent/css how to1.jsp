  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
        ...
        <li><a class='active'href="css how to1.jsp">CSS How to</a></li>
...
<a href = "css icons1.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "css borders1.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
