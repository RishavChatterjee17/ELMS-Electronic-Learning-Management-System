...
<title>Warning! LOGIN REQUIRED</title>
<style>
html{
  overflow: hidden;
}
body{
  background-image: url(Solid-Black-HD-Background-.jpg);
...
<body>
  ...
  <div class="container">
	<h6>You must be logged in <br>Before you can continue.</h6>
	<h6>Please wait you are being redirected to LOGIN PAGE.<br>Click  <a href="login.jsp">here</a> if not redirected withtin 3 seconds.</h6>
