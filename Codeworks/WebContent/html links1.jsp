  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
        ...
        <li><a class='active'href="html links1.jsp">Html Links</a></li>
...
<a href = "html lists1.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "html heads1.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
