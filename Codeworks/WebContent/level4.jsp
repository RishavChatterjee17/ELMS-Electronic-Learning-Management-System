     ...
     <div class="body">
       ...
       <div class="question">
        ...
        <div class="question">
         ...
         <div class="question">
           <h4>You have run an SQL statement that asked the DBMS to display data in a table named USER_TABLES. The results include columns of data labeled "TableName," "NumberOfColumns" and "PrimaryKey." You are looking at ________ .</h4>
          ...
          <h3>Take LEVEL 3 test again:</h3><br>
              <input id="b1" type="button" value="TAKE TEST" onclick="location.href='level3.jsp'">
