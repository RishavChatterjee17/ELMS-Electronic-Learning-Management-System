   ...
   <script src="timer1.js"></script>
     ...
     <div class="body">
       ...
       <div class="question">
        ...
        <div class="question">
          <h3>Which of the following products was an early implementation of the relational model developed by E.F. Codd of IBM?</h3>
          <input type="radio" name="q2"value="a">a.IDMS<br>
            <input type="radio" name="q2"value="b">b.DB2<br>
              <input type="radio" name="q2"value="c">c.dBase-II<br>
                <input type="radio" name="q2"value="d">d.R:base<br>
         </div>
