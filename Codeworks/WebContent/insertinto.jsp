  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
       ...
       <li><a class="active" href="insertinto.jsp">SQL Insert</a></li>
...
<a href = "delete.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "sql_select.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
