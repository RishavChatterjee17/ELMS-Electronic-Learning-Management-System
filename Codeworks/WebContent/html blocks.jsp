  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
        ...
        <li><a class='active'href="html blocks.jsp">Html Blocks</a></li>
...
<a href = "html headings.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "html basic.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
