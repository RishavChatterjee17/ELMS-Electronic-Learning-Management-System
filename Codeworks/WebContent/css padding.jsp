    ...
    <div class="nav-menu1">
      <ul id="menu1">
       ...
       <li><a href="css margins.jsp">Margins</a></li>
        <li><a class='active'href="css padding.jsp">Padding</a></li>
...
<a href = "css syntax.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "css margins.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
