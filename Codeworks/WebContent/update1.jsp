  ...
  <body>
    ...
    <div class="nav-menu1">
     ...
     <li><a  href="sub_sql1.jsp">Introduction to SQL </a></li>
       ...
       <li><a class="active" href="update1.jsp">SQL Update</a></li>
...
<a href = "orderby1.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "delete1.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
