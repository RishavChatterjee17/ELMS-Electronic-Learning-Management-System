  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
        ...
        <li><a class='active' href="html heads1.jsp">Html Heads</a></li>
...
<a href = "html links1.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "html headings1.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
