  ...
  <body>
    ...
    <div class="nav-menu1">
      ...
      <li><a href="sub_sql1.jsp">Introduction to SQL </a></li>
       ...
       <li><a class="active" href="delete1.jsp">SQL Delete</a></li>
...
<a href = "update1.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "insertinto1.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
