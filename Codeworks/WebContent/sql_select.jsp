  ...
  <body>
    ...
    <div class="nav-menu1">
      <ul id="menu1">
       ...
       <li><a class="active" href="sql_select.jsp">SQL Select</a></li>
...
<a href = "insertinto.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "sub_sql.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
