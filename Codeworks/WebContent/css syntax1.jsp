    ...
    <div class="nav-menu1">
      <ul id="menu1">
       ...
       <li><a href="css margins1.jsp">Margins</a></li>
        ...
        <li><a class='active'href="css syntax1.jsp">Syntaxes </a></li>
...
<a href = "cssbackground1.jsp"><button class="next" type="button" name="NEXT">NEXT > </button></a>
<a href = "css padding1.jsp"><button class="previous" type="button" name="PREVIOUS"> < PREV</button></a><br><br><br><br>
