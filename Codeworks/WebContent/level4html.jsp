     ...
     <div class="body">
       ...
       <div class="question">
        ...
        <div class="question">
         ...
         <div class="question">
           <h4>Which attribute is used withimg tag to display the text if image could not load in browser?</h4>
           <input type="radio" name="q3"value="a">a.description<br>
             <input type="radio" name="q3"value="b">b. name<br>
               <input type="radio" name="q3"value="c">c.alt<br>
                 <input type="radio" name="q3"value="d">d. id<br>
          </div><br>

          <button type="submit">SUBMIT TEST</button>
          <h3>Take LEVEL 2 test again:</h3><br>
              <input id="b1" type="button" value="TAKE TEST" onclick="location.href='level3backhtml.jsp'">
